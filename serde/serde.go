...
func DeserializeBool(d *Deserializer, b []byte) (bool, []byte) {
	return b[0] == 1, b[1:]
}
...
func DeserializeUint64(d *Deserializer, b []byte) (uint64, []byte) {
...
func DeserializeUint32(d *Deserializer, b []byte) (uint32, []byte) {
...
func DeserializeUint16(d *Deserializer, b []byte) (uint16, []byte) {
...
func DeserializeUint8(d *Deserializer, b []byte) (uint8, []byte) {
...
func DeserializeInt64(d *Deserializer, b []byte) (int64, []byte) {
...
func DeserializeInt32(d *Deserializer, b []byte) (int32, []byte) {
...
func DeserializeInt16(d *Deserializer, b []byte) (int16, []byte) {
...
func DeserializeInt8(d *Deserializer, b []byte) (int8, []byte) {
	return int8(b[0]), b[1:]
}
...
func DeserializeFloat32(d *Deserializer, b []byte) (float32, []byte) {
	u, b := DeserializeUint32(d, b)
...
func DeserializeFloat64(d *Deserializer, b []byte) (float64, []byte) {
	u, b := DeserializeUint64(d, b)
...
func DeserializeComplex64(d *Deserializer, b []byte) (complex64, []byte) {
	r, b := DeserializeFloat32(d, b)
	i, b := DeserializeFloat32(d, b)
...
func DeserializeComplex128(d *Deserializer, b []byte) (complex128, []byte) {
	r, b := DeserializeFloat64(d, b)
	i, b := DeserializeFloat64(d, b)
	return complex(r, i), b
}
...
func DeserializeString(d *Deserializer, b []byte) (string, []byte) {
	l, n := binary.Varint(b)
	b = b[n:]
