...
func RangeOverMaps(n int) {
	...
	var _o20 int
	var _o21 bool
	var _o22 map[int]struct {
	}
	var _o23 int
	var _o24 map[int]struct {
	}
	var _o25 []int
	var _o26 []int
	var _o27 int
	...
	if _f.IP > 0 {
		...
		if _v := _f.Get(23); _v != nil {
			...
			_o22 = _v.(map[int]struct {
			})
		}
		_o23 = _f.Get(24).(int)
		if _v := _f.Get(25); _v != nil {
			_o24 = _v.(map[int]struct {
			})
		}
	...
	case _f.IP < 8:
		...
		case _f.IP < 8:
			...
			case _f.IP < 7:
				...
				fallthrough
			case _f.IP < 8:
				for ; _o4 < len(_o3); _o4, _f.IP = _o4+1, 7 {
					panic("unreachable")
				}
			}
		}
	...
	case _f.IP < 15:
		...
		case _f.IP < 15:
			...
			case _f.IP < 14:
				...
				fallthrough
			case _f.IP < 15:
				for ; _o8 < len(_o7); _o8, _f.IP = _o8+1, 14 {
		...
		case _f.IP < 23:
			...
			case _f.IP < 23:
				...
				case _f.IP < 20:
					...
					fallthrough
				case _f.IP < 23:
					for ; _o12 < len(_o11); _o12, _f.IP = _o12+1, 20 {
						switch {
						case _f.IP < 21:
							_o13 = _o11[_o12]
							_f.IP = 21
	...
	case _f.IP < 35:
		...
		case _f.IP < 34:
			...
			fallthrough
		case _f.IP < 35:
			for ; _o23 < n; _o23, _f.IP = _o23+1, 34 {
				_o22[_o23] = struct{}{}
			}
		}
		_f.IP = 35
	...
	case _f.IP < 36:
		...
		coroutine.Yield[int, any](len(_o22))
		_f.IP = 36
		fallthrough
	case _f.IP < 45:
		switch {
		...
		case _f.IP < 39:
			switch {
			case _f.IP < 38:
				_o25 = make([]int, 0, len(_o24))
				_f.IP = 38
				fallthrough
			case _f.IP < 39:
				for _v22 := range _o24 {
					_o25 = append(_o25, _v22)
				}
			}
			_f.IP = 39
			fallthrough
		case _f.IP < 45:
			...
			case _f.IP < 45:
				...
				case _f.IP < 41:
					...
					fallthrough
				case _f.IP < 45:
					for ; _o27 < len(_o26); _o27, _f.IP = _o27+1, 41 {
						switch {
						case _f.IP < 42:
							_o28 = _o26[_o27]
							_f.IP = 42
...
func Range10ClosureHeterogenousCapture() {
	...
	if _f.IP > 0 {
		...
		_o16 = _f.Get(3).(int64)
		_o17 = _f.Get(4).(uint8)
		_o18 = _f.Get(5).(uint16)
		_o19 = _f.Get(6).(uint32)
		_o20 = _f.Get(7).(uint64)
		_o21 = _f.Get(8).(uintptr)
					...
					case _f.IP < 32:
						if _o17 {
							...
							case _f.IP < 31:
								...
								fallthrough
							case _f.IP < 32:
								for ; _o18 < 3; _o18, _f.IP = _o18+1, 31 {
									coroutine.Yield[int, any](_o18)
								}
							}
						}
