...
func Shadowing(_ int) {
	...
	const _o16 = 1
	type _o17 [_o16]uint8

	type _o18 [_o16]uint8

	const _o19 = unsafe.Sizeof(_o18{}) * 2
	type _o20 [_o19]uint8
	if _f.IP > 0 {
		_o0 = _f.Get(0).(int)
	...
	case _f.IP < 31:
		...
		coroutine.Yield[int, any](int(unsafe.Sizeof(_o15(0))))
		_f.IP = 31
		fallthrough
	case _f.IP < 32:

		coroutine.Yield[int, any](int(unsafe.Sizeof(_o14(0))))
		_f.IP = 32
		fallthrough
	case _f.IP < 34:
		switch {
	...
	case _f.IP < 35:
		...
		coroutine.Yield[int, any](int(unsafe.Sizeof(_o17{})))
	}
}
...
func RangeOverMaps(n int) {
	...
	var _o38 bool
	var _o39 bool
	var _o40 map[int]struct {
	}
	var _o41 int
	var _o42 bool
	var _o43 map[int]struct {
	}
	var _o44 []int
	var _o45 []int
	var _o46 int
	...
	if _f.IP > 0 {
		...
		_o40 = _f.Get(41).(map[int]struct {
		})
		_o41 = _f.Get(42).(int)
		_o42 = _f.Get(43).(bool)
		_o43 = _f.Get(44).(map[int]struct {
		})
		_o44 = _f.Get(45).([]int)
		_o45 = _f.Get(46).([]int)
		_o46 = _f.Get(47).(int)
	...
	case _f.IP < 29:
		...
		case _f.IP < 21:
			switch {
			case _f.IP < 20:
				_o13 = make([]int, 0, len(_o12))
				_f.IP = 20
				fallthrough
			case _f.IP < 21:
				for _v14 := range _o12 {
					_o13 = append(_o13, _v14)
				}
			}
			_f.IP = 21
			fallthrough
						...
						case _f.IP < 58:
							...
							case _f.IP < 58:
								if _o39 {
									switch {
									case _f.IP < 57:
										coroutine.Yield[int, any](_o36)
										_f.IP = 57
										fallthrough
									case _f.IP < 58:
										coroutine.Yield[int, any](_o37)
									}
								}
							}
						}
	...
	case _f.IP < 64:
		...
		coroutine.Yield[int, any](len(_o40))
		_f.IP = 64
		fallthrough
	case _f.IP < 76:
		switch {
		...
		case _f.IP < 67:
			switch {
			case _f.IP < 66:
				_o44 = make([]int, 0, len(_o43))
				_f.IP = 66
				fallthrough
			case _f.IP < 67:
				for _v43 := range _o43 {
					_o44 = append(_o44, _v43)
				}
			}
			_f.IP = 67
			fallthrough
