...
type Region struct {
	...
	ArrayLength int32 `protobuf:"varint,2,opt,name=array_length,json=arrayLength,proto3" json:"array_length,omitempty"`
...
func (x *Region) GetArrayLength() int32 {
	if x != nil {
...
var file_coroutine_v1_coroutine_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0b, 0x61, 0x72, 0x72, 0x61, 0x79, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12,
